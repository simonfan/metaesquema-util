...
function createArcComposite(options, callback) {
	...
	if (typeof radius !== 'number') {
		throw new TypeError('invalid options.radius')
	}

	if (typeof startAngle !== 'number') {
		throw new TypeError('invalid options.startAngle')
	}

	if (typeof endAngle !== 'number') {
		throw new TypeError('invalid options.endAngle')
	}

	if (typeof sides !== 'number') {
		throw new TypeError('invalid options.sides')
	}
